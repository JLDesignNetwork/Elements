(function(e,t){typeof exports==`object`&&typeof module<`u`?t(exports):typeof define==`function`&&define.amd?define([`exports`],t):(e=typeof globalThis<`u`?globalThis:e||self,t(e.Elements={}))})(this,function(e){Object.defineProperty(e,Symbol.toStringTag,{value:`Module`});function t(e,t){customElements.get(e)||customElements.define(e,t)}var n=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:`open`})}static get observedAttributes(){return[`value`,`max`,`theme`,`variant`,`shape`,`stripes`,`animated`,`size`]}connectedCallback(){this.render()}attributeChangedCallback(e,t,n){t!==n&&this.render()}get value(){return parseFloat(this.getAttribute(`value`))||0}get max(){return parseFloat(this.getAttribute(`max`))||100}get percentage(){return Math.min(100,Math.max(0,this.value/this.max*100))}render(){let e=this.getAttribute(`theme`)||`primary`,t=this.getAttribute(`variant`)||`flat`,n=this.getAttribute(`shape`)||`square`,r=this.getAttribute(`stripes`)||`none`,i=r===`true`||r===`fill`,a=r===`border`,o=this.getAttribute(`animated`)===`true`;this.getAttribute(`theme`)!==e&&this.setAttribute(`theme`,e),this.getAttribute(`variant`)!==t&&this.setAttribute(`variant`,t),this.getAttribute(`shape`)!==n&&this.setAttribute(`shape`,n);let s=`0px`;n===`rounded`?s=`var(--surface-radius, 8px)`:n===`pill`&&(s=`9999px`),this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          position: relative;
    ...
    `}},r=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:`open`})}static get observedAttributes(){return[`theme`,`variant`,`stripes`,`animated`,`size`]}connectedCallback(){this.render()}attributeChangedCallback(e,t,n){t!==n&&this.render()}render(){let e=this.getAttribute(`theme`)||`primary`,t=this.getAttribute(`variant`)||`flat`,n=this.getAttribute(`stripes`)||`none`,r=this.getAttribute(`animated`)===`true`;this.getAttribute(`theme`)!==e&&this.setAttribute(`theme`,e),this.getAttribute(`variant`)!==t&&this.setAttribute(`variant`,t);let i=n===`fill`||n===`border`;this.shadowRoot.innerHTML=`
      <style>
        :host {
    ...
    `}},i=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:`open`})}static get observedAttributes(){return[`theme`,`variant`,`mac-frame`,`language`,`stripes`,`animated`]}connectedCallback(){this.render()}attributeChangedCallback(e,t,n){t!==n&&this.render()}render(){let e=this.getAttribute(`theme`)||`dark`,t=this.getAttribute(`variant`)||`flat`,n=this.getAttribute(`mac-frame`)===`true`,r=this.getAttribute(`language`)||``,i=this.getAttribute(`stripes`)===`true`,a=this.getAttribute(`animated`)===`true`;this.getAttribute(`theme`)!==e&&this.setAttribute(`theme`,e),this.getAttribute(`variant`)!==t&&this.setAttribute(`variant`,t),this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          width: 100%;
    ...
    `}},a=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:`open`})}static get observedAttributes(){return[`theme`,`variant`,`open`,`stripes`,`animated`]}connectedCallback(){this.render()}attributeChangedCallback(e,t,n){t!==n&&this.render()}close(){this.removeAttribute(`open`)}render(){let e=this.getAttribute(`theme`)||`primary`,t=this.getAttribute(`variant`)||`flat`,n=this.hasAttribute(`open`),r=this.getAttribute(`stripes`)===`true`,i=this.getAttribute(`animated`)===`true`;this.getAttribute(`theme`)!==e&&this.setAttribute(`theme`,e),this.getAttribute(`variant`)!==t&&this.setAttribute(`variant`,t),this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
    ...
    `;let a=this.shadowRoot.querySelector(`.backdrop`),o=this.shadowRoot.querySelector(`.close-btn`),s=this.shadowRoot.querySelector(`#modal-content`);a.addEventListener(`click`,e=>{!s.contains(e.target)&&e.target!==s&&this.close()}),o.addEventListener(`click`,()=>{this.close()})}},o=class extends HTMLElement{constructor(){super(),this.attachShadow({mode:`open`})}static get observedAttributes(){return[`theme`,`variant`,`title`,`dismissible`,`stripes`,`animated`]}connectedCallback(){this.render()}attributeChangedCallback(e,t,n){t!==n&&this.render()}dismiss(){this.style.opacity=`0`,this.style.transition=`opacity 0.3s ease`,setTimeout(()=>{this.remove()},300)}render(){let e=this.getAttribute(`theme`)||`primary`,t=this.getAttribute(`variant`)||`flat`,n=this.getAttribute(`title`)||``,r=this.getAttribute(`dismissible`)===`true`,i=this.getAttribute(`stripes`)===`true`,a=this.getAttribute(`animated`)===`true`;this.getAttribute(`theme`)!==e&&this.setAttribute(`theme`,e),this.getAttribute(`variant`)!==t&&this.setAttribute(`variant`,t),this.shadowRoot.innerHTML=`
      <style>
        :host {
          display: block;
          width: 100%;
    ...
    `,r&&this.shadowRoot.querySelector(`.close-btn`).addEventListener(`click`,()=>this.dismiss())}};t(`jl-meter`,n),t(`jl-button`,r),t(`jl-code`,i),t(`jl-popup`,a),t(`jl-alert`,o),e.JLAlert=o,e.JLButton=r,e.JLCode=i,e.JLMeter=n,e.JLPopup=a});